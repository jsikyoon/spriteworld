# Modified by jaesik.yoon.kr@gmail.com
...
CLUSTERS_DISTS = {
    'small': distribs.Discrete('scale', [0.05]),
    'medium': distribs.Discrete('scale', [0.11]),
    'large': distribs.Discrete('scale', [0.2]),
}
...
def get_config(mode='train'):
  ...
  other_factors = distribs.Product([
      ...
      distribs.Discrete('c0', [0.3, 0.6, 0.95]),
